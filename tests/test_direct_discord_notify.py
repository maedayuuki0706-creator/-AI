...
class DeliveryTests(unittest.TestCase):
    ...
    def test_six_racers_parse_despite_whitespace_and_prior_day_results(self):
        ...
        self.assertEqual(boats[0]['boat_number'],40)
        self.assertEqual(boats[0]['boat_top2_rate'],36.17)
        self.assertEqual(boats[0]['boat_top3_rate'],55.32)
    def test_real_exhibition_entry_and_f_are_parsed(self):
        ...
        self.assertIn('exhibition_rank',preview['boats'][5])
